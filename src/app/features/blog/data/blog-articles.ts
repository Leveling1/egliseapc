...
export const FEATURED_ARTICLE: BlogArticle = {
  slug: 'puissance-de-la-foi-resume-culte-dominical',
  category: 'Résumé de culte',
  gradient: 'linear-gradient(135deg,#0b0b0b,#1c1c8c)',
  title: 'La puissance de la foi — Résumé du culte dominical',
  excerpt:
  ...
  content: [
    ...
    "« Que cette semaine soit celle où vous choisissez de croire au-delà de ce que vous voyez », a conclu le Prophète Garry KENGE avant la bénédiction finale. Un message qui restera, pour beaucoup, un point de repère dans leur marche avec Dieu.",
  ],
};

export const BLOG_ARTICLES: readonly BlogArticle[] = [
  {
    slug: 'vivre-sa-foi-en-milieu-professionnel',
    category: 'Article',
    ...
    content: [
      ...
      "Enfin, rappelons-nous que notre vocation professionnelle, quelle qu'elle soit, s'inscrit dans le mandat plus large que Dieu nous a confié : être ses ambassadeurs, en tout lieu et en toute saison (2 Corinthiens 5:20). Le bureau, l'atelier ou le chantier sont, eux aussi, un champ de mission.",
    ],
  },
  {
    slug: 'dieu-a-transforme-ma-vie',
    category: 'Témoignage',
    gradient: 'linear-gradient(135deg,#0B0B0B,#1C1C8C)',
    ...
    date: '21 juil. 2026',
    authorName: 'Marie NGOYI',
    authorInitials: 'MN',
    readingTime: '4 min de lecture',
    content: [
      "Je m'appelle Marie, je fais partie de l'extension de Bruxelles depuis maintenant trois ans. On m'a demandé de partager mon parcours, et j'ai longtemps hésité — parler de soi n'est jamais simple — mais je crois que mon histoire peut encourager quelqu'un qui traverse aujourd'hui ce que j'ai traversé.",
      ...
      "Si vous lisez ce témoignage et que vous traversez une saison difficile, sachez que Dieu n'a pas fini d'écrire votre histoire. Il ne l'avait pas fini pour moi non plus.",
    ],
  },
  {
    slug: 'marcher-dans-la-grace-resume',
    category: 'Résumé',
    ...
    readingTime: '5 min de lecture',
    content: [
      "L'enseignement du mercredi 24 juillet a porté sur un thème central de la vie chrétienne : la grâce. Trop souvent réduite à un simple « pardon des péchés », la grâce biblique est en réalité une puissance qui transforme, soutient et fait avancer le croyant bien au-delà de ses propres forces.",
      ...
      "L'enseignement s'est terminé par un appel à recevoir cette grâce sans culpabilité ni honte, particulièrement pour ceux qui portent le poids d'échecs récents. « Ne laissez personne, pas même vous-même, vous convaincre que vous êtes trop loin pour la grâce de Dieu », a conclu le Prophète Garry KENGE.",
    ],
  },
  {
    slug: 'rda-2026-premieres-annonces',
    category: 'Actualité',
    ...
    date: '15 juil. 2026',
    authorName: 'Rédaction A.P.C',
    authorInitials: 'AC',
    readingTime: '3 min de lecture',
    content: [
      "L'équipe d'organisation du Rassemblement des Aigles (RDA) a le plaisir d'annoncer les premières informations concernant l'édition 2026 de cet événement annuel désormais incontournable pour toute la communauté A.P.C, en République Démocratique du Congo comme dans nos extensions à travers le monde.",
      ...
      "Nous vous invitons à rester connectés à ce blog et aux canaux habituels de communication de l'église pour ne manquer aucune annonce concernant cette édition qui s'annonce, une fois de plus, comme un rendez-vous marquant pour toute la famille A.P.C.",
    ],
  },
  {
    slug: 'appel-du-disciple-resume',
    category: 'Résumé',
    gradient: 'linear-gradient(135deg,#1C1C8C,#0B0B0B)',
    ...
    content: [
      ...
      "L'assemblée a été invitée à un temps de consécration personnelle, chacun étant encouragé à identifier concrètement une zone de sa vie où le renoncement à soi devait encore progresser. Un enseignement qui a résonné comme un appel renouvelé à l'engagement, au-delà des habitudes religieuses.",
    ],
  },
  {
    slug: 'la-priere-arme-du-croyant',
    category: 'Article',
    ...
    content: [
      ...
      "Que cette réflexion soit une invitation, non à la culpabilité, mais au renouvellement : et si, cette semaine, nous redonnions à la prière la place centrale qui lui revient dans notre marche de disciple ?",
    ],
  },
];

export function findArticleBySlug(slug: string): BlogArticle | undefined {
  if (FEATURED_ARTICLE.slug === slug) {
    return FEATURED_ARTICLE;
  }
  return BLOG_ARTICLES.find((article) => article.slug === slug);
}

export function allArticles(): readonly BlogArticle[] {
