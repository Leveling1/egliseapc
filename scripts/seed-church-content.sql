...
-- ------------------------------------------------------------
insert into
    public.oracles (year, title, is_visible)
values (
        2000,
    ...
    (
        2017,
        'Fais vivre ta vision pour une nouvelle dimension',
        true
    ),
    (
        2018,
        'Recommence, car c''est le temps des alliances',
        true
    ),
    (
        2019,
        'Les réparateurs des brèches',
        true
    ),
    (
        2020,
    ...
    (
        2021,
        'Marche dans une nouvelle onction',
        true
    ),
    (
        2022,
        'Vous avez assez demeuré dans cette montagne. Maintenant, avancez !',
        true
    ),
    (
        2023,
        'La possession de notre héritage',
        true
    ),
    (
        2024,
        'Étends la dimension de mon héritage',
        true
    ...
    connus (rang, annee, theme) as (
        values (
            ...
            (
                3,
                2008,
                'L''esprit d''Élie en ce temps'
            ),
            (
                4,
                2009,
                'De l''Épervier, du Faucon et de l''aigle, qui est le vrai'
            ),
            (
                5,
                2010,
                'Ici gît un géant endormi, s''il se réveillait rien ne pourrait l''arrêter'
            ),
            (
                6,
                2011,
                'Que ton royaume descende'
            ),
            (
                7,
                2012,
                'Commence la conquête, fais-lui la guerre'
            ),
            (
                8,
                2013,
                'La guerre des adorateurs'
            ),
            (
                9,
                2014,
            ...
            (
                12,
                2019,
                'Dieu a une armée qui se lève'
            ),
            (
                13,
                2020,
                'Deux races s''affrontent'
            ),
            (
                14,
                2022,
