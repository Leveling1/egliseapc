...
values
  ...
  ('vivre-sa-foi-en-milieu-professionnel', 'Article', 'Vivre sa foi en milieu professionnel',
   ...
   'linear-gradient(135deg,#1C1C8C,#1C1C8C)', '2026-07-24'::date, true),
  ('dieu-a-transforme-ma-vie', 'Témoignage', '« Dieu a transformé ma vie »',
   ...
   'linear-gradient(135deg,#0B0B0B,#1C1C8C)', '2026-07-21'::date, true),
  ('marcher-dans-la-grace-resume', 'Résumé', 'Marcher dans la grâce - Résumé',
   ...
   'Prophète Garry KENGE', 'GK', '5 min de lecture',
   'linear-gradient(135deg,#1C1C8C,rgba(255,255,255,.55))', '2026-07-18'::date, true),
  ('rda-2026-premieres-annonces', 'Actualité', 'RDA 2026 : les premières annonces',
   ...
   'linear-gradient(135deg,#1C1C8C,#0B0B0B)', '2026-07-15'::date, true),
  ('appel-du-disciple-resume', 'Résumé', 'L''appel du disciple - Résumé',
   ...
   'Prophète Garry KENGE', 'GK', '5 min de lecture',
   'linear-gradient(135deg,#1C1C8C,#0B0B0B)', '2026-07-12'::date, true),
  ('la-priere-arme-du-croyant', 'Article', 'La prière : arme du croyant',
   ...
   'linear-gradient(135deg,rgba(255,255,255,.55),#1C1C8C)', '2026-07-08'::date, true)
...
from
    generate_series (1, 18) as n on conflict (edition_number) do nothing;